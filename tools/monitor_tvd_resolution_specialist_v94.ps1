...
$Repo=Split-Path -Parent $PSScriptRoot;$Run=Join-Path $Repo 'artifacts\detached_tvd_resolution_specialist_v94';$PidFile=Join-Path $Run 'pid.txt';$MetaFile=Join-Path $Run 'start_meta.json';$ProgressFile=Join-Path $Run 'progress.json'
