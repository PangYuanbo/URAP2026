param(
  ...
  [string]$RunId = 'aot_action_chunk_transfer_protected_v3'
)
...
$configs = @(
  @{name='b0p40_p0p22'; beta=0.40; protect=0.22},
  @{name='b0p60_p0p22'; beta=0.60; protect=0.22},
  @{name='b0p40_p0p23'; beta=0.40; protect=0.23},
  @{name='b0p60_p0p23'; beta=0.60; protect=0.23}
)
