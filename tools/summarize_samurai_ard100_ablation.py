#!/usr/bin/env python3
"""Summarize the controlled TVD-format ARD100 SAMURAI ablation matrix."""
...
ROWS = {
    "image_box_zero_shot": "ard100_ablation_image_box_zero_shot_test_v1/metrics.json",
    "sam2_video_zero_shot": "ard100_ablation_sam2_video_zero_shot_test_v1/metrics.json",
    "samurai_zero_shot": "ard100_ablation_samurai_zero_shot_test_v1/metrics.json",
    "sam2_video_finetuned1": "ard100_ablation_sam2_video_finetuned_ard100_restart1_test_v1/metrics.json",
    "samurai_finetuned1": "ard100_ablation_samurai_finetuned_ard100_restart1_test_v1/metrics.json",
}
...
def main() -> int:
    ...
    pairs = {
        ...
        "ard100_finetune_sam2": ("sam2_video_finetuned1", "sam2_video_zero_shot"),
        "ard100_finetune_samurai": ("samurai_finetuned1", "samurai_zero_shot"),
    ...
    lines = ["# SAMURAI TVD-format ARD100 Ablation", "", "| Row | AUC | mIoU | IoU>=0.5 | P@20 |", "|---|---:|---:|---:|---:|"]
    for name in ROWS:
        row = rows.get(name)
        if row is None:
