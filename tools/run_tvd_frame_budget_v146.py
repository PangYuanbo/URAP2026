...
RUN=ROOT/"artifacts"/"detached_tvd_frame_budget_v146";OUT=Path(r"D:\URAP_vatd_rank_results\tvd_frame_budget_v146");TVD=Path(r"D:\urap_modal_stage\TransVisDrone");VATD=.93844
...
def main():
 ...
 for k in (1,2,3,4,5,8,10,15):
  for factor in (0,.01,.03,.05,.1,.2,.4,.6,.8):
   for gate in (.05,.1,.2,.4,1.0):
