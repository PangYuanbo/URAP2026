param(
    ...
    [double]$TrackletClassifierThreshold = 0.95,
    [ValidateSet("keep", "suppress")]
    [string]$TrackletFilterUntracked = "keep",
    [switch]$DisableTrackletPromotion = $true,
    [double]$TrackletPromotionScoreFloor = 0.00,
    [double]$TrackletPromotionMinBranchDrone = 0.40,
    [double]$TrackletPromotionMaxBackground = 0.00,
    [int]$MaxFrames = 0,
