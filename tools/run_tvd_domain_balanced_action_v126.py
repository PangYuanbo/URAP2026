...
OUT = Path(r"D:\URAP_vatd_rank_results\tvd_domain_balanced_action_v126")
RUN = ROOT / "artifacts" / "detached_tvd_domain_balanced_action_v126"
SIZE_MAP = ROOT / "data_templates" / "nps_sequence_sizes_actual.json"
RATIOS = (0.70, 1.50, 3.00, 6.00)
VATD_MAP50 = 0.93844
...
def main() -> int:
    ...
    summary = {
        "protocol": "correct unified-label train supervision; validation-OOF-selected hard-row ratio; fixed test",
