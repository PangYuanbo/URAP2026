...
R=Path(r'C:\Users\aaron\Desktop\URAP');RUN=R/'artifacts'/'detached_tvd_hard_noval_posteval_v107';P=RUN/'progress.json';TRAIN_RUN=R/'artifacts'/'detached_tvd_detector_hard_finetune_v106';TRAIN_OUT=Path(r'D:\URAP_vatd_rank_results\tvd_detector_hard_finetune_v106\hard8_img960_noval_e4');REPO=Path(r'U:\URAP_cold_storage\Desktop_URAP\papers\TransVisDrone');OUT=Path(r'D:\URAP_vatd_rank_results\tvd_detector_hard_finetune_v106_eval')
...
def main():
 ...
 if done<4 or not weights.exists():report('training_not_complete',0,training_pid=train_pid,epochs_done=done,epochs_total=4,weights_exists=weights.exists());return 2
