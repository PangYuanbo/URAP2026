...
P=Path(r'D:\URAP_nps_train_tvd\runs\nps_train_rank_source\predictionsgt\predictionsgt_split_0_fixed_canvas.pkl');O=Path(r'D:\URAP_vatd_rank_results\tvd_train_fixed_sequence_v97\train_sequence_metrics.json')
def main():
