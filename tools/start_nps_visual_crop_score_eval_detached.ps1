...
$process=Start-Process -FilePath $python -ArgumentList @((Join-Path $RepoRoot 'tools\run_nps_visual_crop_score_eval.py')) -WorkingDirectory $RepoRoot -RedirectStandardOutput $stdout -RedirectStandardError $stderr -WindowStyle Hidden -PassThru
