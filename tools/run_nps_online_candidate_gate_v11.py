...
RUN = REPO / "artifacts" / "detached_nps_online_candidate_gate_v11"
PROGRESS = RUN / "progress.json"
OUT = Path(r"D:\URAP_vatd_rank_results\nps_online_candidate_gate_v11")
...
def main() -> int:
    ...
    summary = {
        ...
        "selector": "causal 1s/3s online Action Bank candidate gate with one-to-one candidate/GT supervision",
