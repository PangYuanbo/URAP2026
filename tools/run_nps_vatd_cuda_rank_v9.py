...
OUT = REPO / "tmp/nps_vatd_cuda_rank_v9"
RUNNER = REPO / "tmp/nps_vatd_cuda_rank_v9_runner"
PROGRESS = RUNNER / "progress.json"
PYTHON = Path(r"C:\Users\aaron\AppData\Roaming\uv\python\cpython-3.10-windows-x86_64-none\python.exe")
VENV = REPO / "papers/TransVisDrone/.venv"
