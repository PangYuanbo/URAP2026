...
BEST=Path(r'D:\URAP_nps_val_tvd\runs\nps_val_rank_source\predictionsgt\predictionsgt_split_0_official_labels.pkl');LAST=Path(r'U:\URAP_cold_storage\Desktop_URAP\papers\TransVisDrone\runs\val\NPS_URAP\official_last_val_savegt\predictionsgt\predictionsgt_split_0.pkl');OUT=Path(r'D:\URAP_vatd_rank_results\tvd_best_last_val_fusion_v163');TVD=Path(r'D:\urap_modal_stage\TransVisDrone')
