...
if($Progress){"done/total: $($Progress.done)/$($Progress.total)";"stage: $($Progress.stage)";"last_output_timestamp: $((Get-Item $ProgressPath).LastWriteTime)"}else{'done/total: 0/1';'stage: starting'}
