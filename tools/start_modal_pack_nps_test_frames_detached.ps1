...
$process=Start-Process -FilePath 'C:\Users\aaron\.local\bin\modal.exe' -ArgumentList @('run',(Join-Path $RepoRoot 'tools\modal_pack_nps_test_frames.py')) -WorkingDirectory $RepoRoot -RedirectStandardOutput $stdout -RedirectStandardError $stderr -WindowStyle Hidden -PassThru
